...
bot = telebot.TeleBot('7150846110:AAGd8Dy-NxobgXHoqjYlW_DXMQFE28SIqWc')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- python_manager")
...
Buy From :- @python_manager
Official Channel :- https://t.me/+TBUbtaf_XYRhYTdl
'''
...
1. Dont Run Too  !! Cause A Ban From Bot
2. Dont Run At Same Time Becz If U Then U Got Banned From Bot.
...
def welcome_plan(message):
    user_name = message.from_user.first_name
    response = f'''{user_name}, Brother Only 1 Plan Is Powerfull Then Any Other !!:
